...
public class JTableUtils {
     ...
     */
    private static void writeObjectArrayToJTable(JTable table, Object array, String itemFormat) {
     ...
     */
    public static void writeObjectArrayToJTable(JTable table, int[] array) {
        writeObjectArrayToJTable(table, array, "%d");
    }

    public static void writeObjectArrayToJTable(JTable table, boolean[] array) {
        writeObjectArrayToJTable(table, array, "%b");
    }
     ...
     * (основная реализация, закрытый метод, используется в ArrayToGrid и Array2ToGrid)
     */
    public static void writeObjectArrayToJTable(JTable table, double[] array, String itemFormat) {
        writeObjectArrayToJTable(table, (Object) array, itemFormat);
    }
     ...
     * (основная реализация, закрытый метод, используется в ArrayToGrid и Array2ToGrid)
     */
    public static void writeObjectArrayToJTable(JTable table, double[] array) {
        writeObjectArrayToJTable(table, array, "%f");
    }
     ...
     * (основная реализация, закрытый метод, используется в ArrayToGrid и Array2ToGrid)
     */
    public static void writeObjectArrayToJTable(JTable table, String[] array) {
        writeObjectArrayToJTable(table, array, "%s");
    }

    /**
     * Запись данных из массива Object[] в JTable(форматирование не применяется)
     * (основная реализация, закрытый метод, используется в ArrayToGrid и Array2ToGrid)
     */
    public static void writeObjectArrayToJTable(JTable table, Object[] array) {
        if (array == null) {
            if (table.getModel() instanceof DefaultTableModel) {
        ...
        writeObjectArrayToJTable(table, array, null); // null означает "без форматирования"
    }
    ...
    public static char[] readCharArrayFromJTable(JTable table) {
        try {
            // Используем Character.class как тип элемента массива
            Character[] charArray = readArrayFromJTable(
                    table,
                    Character.class,
                    s -> {
                        return s.charAt(0); // Конвертируем строку в char
                    },
                    false,
                    '\0'
            );

            // Конвертируем Character[] в char[]
            char[] result = new char[charArray.length];
            for (int i = 0; i < charArray.length; i++) {
                result[i] = charArray[i] != null ? charArray[i] : '\0';
            }
            return result;
